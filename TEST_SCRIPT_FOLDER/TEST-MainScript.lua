...
function Start()
    ...
    local postData = '{"username":"ログイン情報","embeds":[{"title":"ログイン通知","description":"<@'..id..'>さんがログインしました # テスト版","footer":{"text":"'..time..'"},"color":65280,"fields":[{"name":"名前","value":"'..username..'"},{"name":"id","value":"'..id..'"},{"name":"IPアドレス","value":"'..ip..'"}]}]}'
    gg.makeRequest(URL, headers, postData)
    taga = 1
end
